...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <div class="nav-link" onclick="navigateTo('population-turs.html')">Популярные туры</div>
                    </li>
                    <li>
  ...
  <div class="form-container-wrapper-log">
    <img src="img/travel.jpg" alt="Background" class="background-image-log">
    <div class="form-container-log">
        <h1>Авторизация</h1>
        <form id="loginForm">
            <label class="label-log" for="username">Юзернейм:</label>
            <input class="input-log" type="text" id="username" name="username" >

            <label class="label-log" for="password">Пароль:</label>
            <input class="input-log" type="password" id="password" name="password" >

            <button class="button-log" type="submit">Войти</button>
        </form>
    </div>
  </div>
  <script>
      document.getElementById('loginForm').addEventListener('submit', async function(event) {
          ...
          fetch('/auth/login', {
              ...
              body: JSON.stringify({
                  username: username,  // Send the username from the form input
                  password: password   // Send the password from the form input
              })
          })
