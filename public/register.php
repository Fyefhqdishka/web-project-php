...
<body>
  ...
  <div class="form-container-wrapper-log">
    <img src="img/tour.jpeg" alt="Background" class="background-image-log">
    <div class="form-container-log">
        <h1>Регистрация</h1>
        <form id="registerForm">
            <label for="name" class="label-log">Имя:</label>
            <input type="text" id="name" name="name" class="input-log" required>

            <label for="username" class="label-log">Юзернейм:</label>
            <input type="text" id="username" name="username" class="input-log" required>

            <label for="email" class="label-log">Почта:</label>
            <input type="email" id="email" name="email" class="input-log" required>

            <label for="password" class="label-log">Пароль:</label>
            <input type="password" id="password" name="password" class="input-log" required>
      ...
      document.getElementById('registerForm').addEventListener('submit', async function(event) {
          ...
          try {
              ...
              if (response.ok) {
                  ...
                  document.getElementById('registerMessage').textContent = `Ошибка: ${data.error}`;
              }
          } catch (error) {
